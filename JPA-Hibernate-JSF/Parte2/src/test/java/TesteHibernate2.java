...
public class TesteHibernate2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*Vamos buscar um Usuário pelo "id" e modificar */
		Usuario usuarioModificar = usuarioDAO.buscarPorId(4);
		//System.out.println(usuarioModificar);
		//usuarioModificar.setUsuario("jana123");
		//usuarioDAO.salvar(usuarioModificar);
		
		usuarioDAO.excluir(usuarioModificar);
	}
