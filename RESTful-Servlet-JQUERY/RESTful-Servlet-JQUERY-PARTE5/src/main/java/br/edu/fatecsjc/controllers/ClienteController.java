...
import br.edu.fatecsjc.model.Cliente;
...
public class ClienteController extends HttpServlet{
	...
	*/
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		/*
		 Vamos trabalhar com a ideia de serialização, ou seja, pegamos um dado no padrão JSON e converto
		 ele para um OBJETO JAVASCRIPT. Então vamos transformar uma string no padrão "JSON" em um objeto
		 JS 
		*/
